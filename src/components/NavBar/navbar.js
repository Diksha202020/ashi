...
const Navbar = () => {
  ...
  return (
    <nav className='navbar'>
        ...
        <a href="https://www.linkedin.com/in/diksha-pandey-34814a226"><img src={LinkedIn} alt='linkedin' className='linkedinImg' onClick={()=>newTab('https://www.linkedin.com/in/diksha-pandey-34814a226')}/></a>
